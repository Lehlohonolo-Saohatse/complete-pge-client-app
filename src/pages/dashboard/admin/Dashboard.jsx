...
import { FaBook, FaDollarSign, FaMoneyCheck, FaUsers } from "react-icons/fa";
import {
  BarChart,
  Bar,
  Cell,
    ...
    <div className="w-full md:w-[870px] mx-auto px-4 ">
      ...
      <div className="stats shadow flex flex-col md:flex-row">
        <div className="stat bg-emerald-200">
          ...
          <FaMoneyCheck className="text-3xl"></FaMoneyCheck >
          </div>
          <div className="stat-title">Revenue</div>
          <div className="stat-value">R{stats.revenue}</div>
